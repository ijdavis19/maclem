...
\JournalInfo{1-\pageref{LastPage}, 2020} % Journal information
...
\begin{table*}[t]
  \centering
  \caption{NAMCS Variables} %Comment out variables and find the right place to split
  \begin{tabular}{|c|c|c|}
  \hline
...
\begin{table*}[h!]
  \centering
  \caption{NAMCS Variables (cont.)} %Comment out variables and find the right place to split
  \begin{tabular}{|c|c|c|}
  \hline
  Variable & Description & Category\\
  \hline
