...
%
\title{The Effect of Generic Entry on Probability of Prescriptions in Emergency Departments: A Case Study on Sulfamethozaxole-Trimethoprim}
...
\committeeMemberOne{Lawrence Reed Watson}
\committeeMemberTwo{Dr. Michael McCowsky}
...
%  ===========================================================================
    ...
    \inputfile{litReview.tex}
    \inputfile{economicFramework.tex}
    \inputfile{dataBackground.tex}
